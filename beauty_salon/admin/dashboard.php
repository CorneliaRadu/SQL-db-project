...
<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Bun venit  <?php echo $admin; ?></a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="dashboard.php?option=update_password">Update Parola</a></li>
            <li><a href="dashboard.php?option=feedback">Feedback</a></li>
            <li><a href="dashboard.php?option=rooms">Servicii</a></li>
			<li><a href="dashboard.php?option=booking_details">Detalii programari</a></li>
      <li><a href="dashboard.php?option=user_registration">Registru clienti</a></li>
