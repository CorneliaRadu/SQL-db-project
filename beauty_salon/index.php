...
<div class="container text-center">    
  <h1>Bun venit la <font color="#a6e22b;"><b> EXTREME SALON </b></font></h1><hr><br>
  <div class="row">
	...
	<div class="col-sm-4">
      ...
      <h4 class="Room_Text">[ <?php echo $r_res['nume']; ?>]</h4>
      <p class="text-justify"><?php echo substr($r_res['detalii'],0,100); ?></p><br>
