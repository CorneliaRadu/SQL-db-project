...
if(isset($login))
{
	if($eid=="" || $pass=="")
	{
	$error= "<h3 style='color:yellow'>fill all details</h3>";	
	}		
	else
	{
	$sql=mysqli_query($con,"select * from admin where username='$eid' && parola='$pass' ");
  ...
  <div class="container">
    <div class="row"><br>
      <div class="col-sm-4"></div>
		<div class="col-sm-4 text-center"style="box-shadow:2px 2px 2px;background-color:black;">
