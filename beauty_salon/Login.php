...
if(isset($login))
{
  if($eid=="" || $pass=="")
  {
  $error= "<h4 style='color:red'>completati toate randurile</h4>";  
  }   
  else
  {
  $sql=mysqli_query($con,"select * from creaza_cont where email='$eid' && parola='$pass' ");
    ...
    {
    $error= "<h4 style='color:red'>Detalii invalide</h4>"; 
    } 
  }
}
?>
      ...
      <div class="col-sm-4"></div>
        <div class="col-sm-4 text-center"style="box-shadow:2px 2px 2px;background-color:#f4ac41;"><br>
          ...
          <form method="post"><br>
            ...
            <div class="form-group">
                <input type="parola" class="form-control"name="pass"placeholder="parola" autocomplete="off"required>
            </div>
          <input type="submit" value="Login" name="login" class="btn btn-primary btn-group btn-group-justified"required>
          <div class="form-group forget">
               
                <a href="Registation form.php">Creaza cont</a>
            </div>
      	</form><br>
        </div>
    </div><br>
